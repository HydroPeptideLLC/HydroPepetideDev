		...
		images: {
			loadBackgrounds: function() {
				...
				$elementsToLoad.each(function() {
					...
					if(src == '') {
						src = '//cdn.shopify.com/s/files/1/0266/5142/6915/t/29/assets/placeholder-pattern.png?v=53006066011181622771663280157';
						placeholder = true;
					}
					...
					$(im).on('error', function() {
						$el.css('background-image', 'url(//cdn.shopify.com/s/files/1/0266/5142/6915/t/29/assets/placeholder-pattern.png?v=53006066011181622771663280157)')
